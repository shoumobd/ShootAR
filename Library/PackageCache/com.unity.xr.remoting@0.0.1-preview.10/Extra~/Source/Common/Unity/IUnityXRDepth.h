...
UNITY_DECLARE_INTERFACE(IUnityXRDepthInterface)
{
    ...
    ///                      UnityXRDepthProvider::GetPointCloud, pass it
    ...
    ///                      UnityXRDepthProvider::GetPointCloud, pass it
    ///                      back here for this call to succeed.
    /// @return              An array of UnityXRVector3s to populate with point cloud positions.
    ...
    ///                      UnityXRDepthProvider::GetPointCloud, pass it
    ///                      back here for this call to succeed.
    /// @return              An array of floats to populate with point cloud confidence values.
